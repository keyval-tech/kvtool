package com.kovizone.tool.json.parser;

import com.kovizone.tool.core.StringUtil;
import com.kovizone.tool.json.JsonArray;
import com.kovizone.tool.json.JsonObject;
import com.kovizone.tool.json.annotation.DateFormat;
import com.kovizone.tool.json.annotation.JsonSerializable;
...
public class ObjectParser {
    ...
    private JsonObject parseObject(Object object) throws KvJsonParseException {
        ...
        for (Field field : fields) {
            ...
            if (!Modifier.isStatic(field.getModifiers())) {
                ...
                if (intrusive) {
                    ...
                    String upperFieldName = StringUtil.upperFirstCase(fieldName);
        ...
        if (object.getClass().isAnnotationPresent(JsonSerializable.class)) {
            jsonObject.put("kClass", object.getClass().getName());
        }
        return jsonObject;
    }
